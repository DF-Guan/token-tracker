...
_STRINGS = {
    "zh": {
        ...
        "available_cmds": "可用命令: dashboard, daily, weekly, monthly, sessions, theme, setup, unsetup, --version",
        "sort_time": "时间",
        "sort_token": "Token",
        "sort_cost": "等效成本",
        "sort_messages": "消息数",
    ...
    "en": {
        ...
        "available_cmds": "Available commands: dashboard, daily, weekly, monthly, sessions, theme, setup, unsetup, --version",
        "sort_time": "Time",
        "sort_token": "Token",
        "sort_cost": "Cost",
